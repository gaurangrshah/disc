...
const roleIconMap = {
  GUEST: <User className='ml-2 h-4 w-4 text-gray-500' />,
  MEMBER: <ShieldCheck className='ml-2 h-4 w-4 text-indigo-500' />,
...
export function ChatItem({
  ...
  const isImage = !isPDF && fileUrl; // we already only accept image and pdf files for now.
  // a more robust solution would be to check the file type from the server.
